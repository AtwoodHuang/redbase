...
public:
    virtual bool eval(const void* lhs, CompOp op, const void* rhs);
};
...
bool IntComp::eval(const void* lhs, CompOp op, const void* rhs)
{
...
bool FloatComp::eval(const void* lhs, CompOp op, const void* rhs)
{
    if (op == NO_OP) return true;
...
bool StrComp::eval(const void* lhs, CompOp op, const void* rhs)
{
    if (op == NO_OP) return true;
